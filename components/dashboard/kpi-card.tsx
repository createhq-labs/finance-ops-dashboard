...
export function KpiCard({
  ...
  return (
    <section className="group rounded-2xl border border-border/60 bg-card p-4 shadow-[0_1px_3px_rgba(15,23,42,0.05)] transition duration-150 hover:border-primary/15 hover:shadow-[0_4px_12px_rgba(15,23,42,0.06)]">
      <div className="flex min-h-[112px] flex-col justify-between gap-4">
        <div className="flex items-start justify-between gap-3">
          <p className="pr-3 text-[15px] font-medium leading-5 text-foreground">
            {title}
          </p>
        ...
        <div>
          <p className="break-words text-[clamp(2rem,2.7vw,2.8rem)] font-bold leading-none tracking-[-0.06em] text-foreground">
            {value}
          </p>
          {hint ? (
